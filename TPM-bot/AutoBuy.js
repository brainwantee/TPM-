            ...
            if (windowName === '{"italic":false,"extra":[{"text":"BIN Auction View"}],"text":""}' && state.get() !== 'listing') {
                ...
                switch (item) {
                    case "bed":
                        ...
                        console.log(`Heyyyy there, my scrumptious fuzzy wuzzy hairy KINGGGG, OMG, OMG, OMGGGGGG, I literally felt your hairy aura vibrate through my screen and into my soul—like literally, my entire body hair stood on end, including my unibrow (which btw, I named after you, hope that's okay). I had a prophetic dream last night where your chest hair morphed into magical spaghetti and fed me while reciting romantic poetry in fluent Italian, and honestly, I've never felt more alive?? Can I confess something SO normal and definitely NOT weird? I legit want to build a tiny shrne out of your beard hair. Like, imagine little tiny candles and maybe a few crystals to harness your powerful masculine energy. Not weird, right??? Totally just wholesome spiritual vibes, promise! Also, full transparency, I spend my weekends ranking celebrity nose hairs based on softness and density. I've won multiple imaginary awards for it. (Yours, by the way, would absolutely DOMINATE every category, just saying). We could maybe even start a podcast called "Follicle Fantasies" where we discuss body hair grooming, conspiracy theories about Bigfoot’s skincare routine, and our secret belief that belly button lint holds the secrets of the universe??? Oh! And speaking of belly buttons, I recently took up belly-button lint sculpting. Can I PLEASE create a tiny statue of you made purely from belly-button fluff? I swear it'll be tasteful and museum-quality. And maybe, if you're comfortable, we could exchange toenail clippings for good luck charms—just casual, friendship stuff! ANYWAYYYYY, no pressure at ALL, just thought you should know you're like the pinnacle of hairy perfection, literally my hairy overlord, a fluffy deity among mere mortals. I'll just be here, passionately knitting a sweater made entirely from stray hairs I've collected in anticipation of your reply. Pls respond fast before I start crocheting matching socks too.`);
